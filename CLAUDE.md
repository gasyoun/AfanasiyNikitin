...
**Афанасий Никитин — Интерактивный Атлас** is a collection of 33 interactive visualizations documenting the 1467–1475 journey of the Russian merchant Afanasiy Nikitin to India. The project supplements Dmitri Khrustalev's 2026 academic work "Тетради купца Афанасия" (Nestor-Istoriya Publishers).
...
├── index.md                          # Master index of all 33 visualizations
├── use_cases_and_guide.md            # Educational use cases & instructions
├── data/                             # FAIR data spine: 12 CSV + 6 exports + datapackage.json (CC-BY) — source of truth
...
| `data/README.md` | The FAIR data spine: 12 CSV datasets + 6 derived exports, conventions, reconciliation, citation/DOI steps |
