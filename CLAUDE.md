...
├── data/                             # FAIR data spine: 9 datasets + datapackage.json (CC-BY)
...
└── [26 more visualization .html files]
```
