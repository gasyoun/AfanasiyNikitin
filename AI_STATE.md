...
> **Commits:** 822c69b (FIX 7), e84dd80 (FIX 6), 579480b (FIX 5), 6ceaf32 (FIX 8), beb79bd (PWA), 5d7caaa (A5 map), 88545c7 (date wording), d4d9c33 (A5 travelers), 2fd59e9 (A5 borders), plus A5 trade follow-up
...
|-------|----------|------|-------|
| Remaining canvas dark palettes | Medium | `afanasy_video_export.html`, `afanasy_world_before_after.html` | Main map, four-travelers map, borders animation, and trade marshruttnik are fixed; remaining Canvas widgets still need the same no-filter/theme-aware drawing audit |
...
1. **A5 remaining canvases** — apply theme-aware drawing to video export and world before/after canvases
