...
|-------|----------|------|-------|
| Existing 1366×768 page scroll | Medium | multiple widgets | Compact shell and chart/video/trade/travelers/manuscripts/bestiary/borders passes fixed near-threshold pages; remaining overflow pages: trade guide and language map. |
...
10. 🔄 **No-scroll layout** — shared shell + four chart widgets + video export + trade map + travelers + manuscripts + bestiary + borders compacted; trade guide and language map still need widget-specific compaction
